...
public enum MapleBuffStat implements Serializable, Buffstat {
    ...
    //物理傷害減少百分比(重生的輪行蹤)   [完成-185]
    INDIE_ASR_R(33, true), //indieAsrR
    //魔法傷害減少百分比(重生的輪行蹤)   [完成-185]
